...
import logo from '../assets/images/logo-img.png';  // Import the logo image
            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarToggler">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="/past-readings">Past Readings</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/AskQuestion">Ask a Question</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/tarot-guide">Tarot Guide</a>
                        </li>
                        <li className="nav-item">
